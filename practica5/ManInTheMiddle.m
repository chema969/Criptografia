...
disp(mensajegp); 
disp(newline )
%Creamos tres números aleatorios, uno para A, otro para B y otro para C
r = randi([2 p-1],1,3);
...
mensajeB=['B genera un número aleatorio ',num2str(r(2)),' y transmite ',num2str(transmision_B)];
...
disp(newline )
disp('A y B calculan la clave común con los datos que tienen (Los de C)');
...
disp("EL INTRUSO CALCULA TAMBIÉN LAS CLAVES")
